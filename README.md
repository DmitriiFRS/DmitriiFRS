# Привет мир! 👋
### Меня зовут Дмитрий, я Fullstack разработчик с уклоном во Frontend (Middle Frontend, Junior Backend). Работаю в основном с Next.js, и с Nest.js. Разрабатываю интернет-магазины, сайты-каталоги разной сложности. Так же занимаюсь развертыванием и поддержкой приложений на облачных сервисах и хостингах. На данный момент занимаюсь углубленным изучением Backend разработки. Мои проекты:
