...
* **[Ethnologistics Admin](https://dashboard.ethnologistics.com/)** — Разработка международной платформы для управления логистикой (BFF паттерн, Next.js, Tailwind). Реализовал сложную бизнес-логику на клиенте (Комплексные формы, интерактивные дашборды, высокопроизводительные таблицы).
